...
public class ReOrderFromOrderHistory extends BaseClass {
	HomePage homePage;
	LoginPage loginPage;
	...
	public void reOrder() throws InterruptedException {
		...
		orderHistory.recentOrder.click();
		test.log(LogStatus.INFO, "clickedOnLastOrder");

		orderHistory.reOrder.click();
		test.log(LogStatus.INFO, "clickedOnReOrder");
		asert.assertEquals(driver.getTitle(), "Order - My Store");

		shoppingCart = new ShoppingCart(driver);
		shoppingCart.addBlouse.click();
		test.log(LogStatus.INFO, "clickedOnAddBtn");

		shoppingCart.deletePrintDress.click();
		test.log(LogStatus.INFO, "clickedOnDeletePrintDress");
		shoppingCart.proceedToCheckOut.click();
		test.log(LogStatus.INFO, "clickedOnCheckOutOnOrderPage");
		shoppingCart.proceedToCheckOut2.click();
		test.log(LogStatus.INFO, "confirmAddressPage");
